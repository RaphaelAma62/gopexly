        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { icon: '💼', title: 'Portfolio Tracker', desc: 'Track your holdings, see live P&L, set wealth goals.' },
              { icon: '📚', title: 'Learn & Earn', desc: 'Complete investing courses. Earn points and climb the leaderboard.' },
              { icon: '🔒', title: 'Privacy First', desc: 'Your portfolio ₦ value is always private. Only you can see it.' },
              { icon: '📰', title: 'Market News', desc: 'Curated financial news from our editors, delivered into your feed.' },
            ].map(f => (
